                    ...
                    <li class="chapter modules">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/TasksModule.html" data-type="entity-link">TasksModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#controllers-links-module-TasksModule-e110818d4e5b737d38e38e208a8d32b1"' : 'data-target="#xs-controllers-links-module-TasksModule-e110818d4e5b737d38e38e208a8d32b1"' }>
                                            <span class="icon ion-md-swap"></span>
                                            <span>Controllers</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="controllers-links-module-TasksModule-e110818d4e5b737d38e38e208a8d32b1"' :
                                            'id="xs-controllers-links-module-TasksModule-e110818d4e5b737d38e38e208a8d32b1"' }>
                                            <li class="link">
                                ...
                                <li class="chapter inner">
                                    <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                        'data-target="#injectables-links-module-TasksModule-e110818d4e5b737d38e38e208a8d32b1"' : 'data-target="#xs-injectables-links-module-TasksModule-e110818d4e5b737d38e38e208a8d32b1"' }>
                                        <span class="icon ion-md-arrow-round-down"></span>
                                        <span>Injectables</span>
                                        <span class="icon ion-ios-arrow-down"></span>
                                    </div>
                                    <ul class="links collapse" ${ isNormalMode ? 'id="injectables-links-module-TasksModule-e110818d4e5b737d38e38e208a8d32b1"' :
                                        'id="xs-injectables-links-module-TasksModule-e110818d4e5b737d38e38e208a8d32b1"' }>
                                        <li class="link">
